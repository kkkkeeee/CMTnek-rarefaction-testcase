### makefile automatically created by makenek 05/26/2017 12:17:31 ###
BINNAME=nek5000
LIBNAME=libnek5000.a
CASENAME:=rarefaction
CASEDIR:=/p/lscratchv/zhai1/rarefaction-cmtnek/try/lb
S:=/g/g90/zhai1/Davidsend/send-5.10/loadBal-Nek5000/core
SCMT:=/g/g90/zhai1/Davidsend/send-5.10/loadBal-Nek5000/core/cmt
J:=/g/g90/zhai1/Davidsend/send-5.10/loadBal-Nek5000/jl
OPT_INCDIR=./
OBJDIR=obj
IFMPI:=true
IFCMT:=true
...
CC:=mpixlc
FFLAGS:=-qrealsize=8 -qdpc=e -qsuffix=cpp=f
CFLAGS:=
PPPO=-WF,
PPS=CMTNEK EXTBAR MPIIO MPI GLOBAL_LONG_LONG
G:=
USR:=
USR_LFLAGS:=
IFVISIT=
